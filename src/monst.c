...
#define SIZ(wt,nut,pxl,snd,siz) wt,nut,pxl,snd,siz,1
/* SIZ2() are for monsters which have slow movement and attack quickly */
#define SIZ2(wt,nut,pxl,snd,siz,pmv) wt,nut,pxl,snd,siz,pmv
 ...
 */
    ...
    MON("tse-tse fly", S_ANT,
	LVL(5, 18, 0, 0, 0), (G_GENO|G_NOGEN|G_SGROUP),
	A(ATTK(AT_STNG, AD_DISE, 1, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(1, 5, 0, MS_BUZZ, MZ_TINY), MR_POISON, 0,
 ...
 */
	...
	LVL(5, 8, 8, 0, 0), (G_GENO|2),
	A(ATTK(AT_TUCH, AD_PHYS, 1, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ2(200, 100, 0, MS_SILENT, MZ_SMALL, 8),
 ...
 */
	...
	M2_NOPOLY|M2_WERE|M2_HOSTILE, M3_INFRAVISIBLE, CLR_BROWN),
    MON("warg", S_DOG,
	LVL(7, 12, 4, 0, -5), (G_GENO|G_SGROUP|G_NOCORPSE|2),
 ...
 */
	...
	LVL(6, 6, 8, 20, 0), (G_GENO|2),
	A(ATTK(AT_ENGL, AD_ACID, 3, 6), ATTK(AT_NONE, AD_ACID, 3, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ2(50, 20, 0, MS_SILENT, MZ_MEDIUM, 2), MR_ACID|MR_STONE, 0,
	M1_BREATHLESS|M1_AMORPHOUS|M1_NOEYES|M1_NOLIMBS|M1_NOHEAD|
	  M1_MINDLESS|M1_ACID|M1_NOTAKE,
 ...
 */
    MON("kobold", S_KOBOLD,
	LVL(0, 9, 10, 0, -2), (G_GENO|1),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(400, 100, 0, MS_ORC, MZ_SMALL), MR_POISON, 0,
	M1_HUMANOID|M1_POIS|M1_OMNIVORE, M2_HOSTILE|M2_COLLECT|M2_RIDE,
	M3_INFRAVISIBLE|M3_INFRAVISION, CLR_BROWN),
    MON("large kobold", S_KOBOLD,
	LVL(1, 10, 10, 0, -3), (G_GENO|1),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
 ...
 */
	...
	LVL(7, 6, 7, 0, 0), (G_GENO|2),
	A(ATTK(AT_CLAW, AD_PHYS, 3, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ2(300, 200, 0, MS_SILENT, MZ_MEDIUM, 2), MR_ACID, 0,
 ...
 */
	 ...
	 */
    MON("orc", S_ORC,
	LVL(1, 8, 10, 0, -3), (G_GENO|G_NOGEN|1),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	M3_INFRAVISIBLE|M3_INFRAVISION, CLR_RED),
    MON("hill orc", S_ORC,
	LVL(2, 10, 10, 0, -4), (G_GENO|G_LGROUP|2),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	LVL(3, 10, 10, 0, -5), (G_GENO|G_LGROUP|1),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(1200, 200, 0, MS_ORC, MZ_HUMAN), 0, 0, M1_HUMANOID|M1_OMNIVORE,
	M2_ORC|M2_STRONG|M2_GREEDY|M2_JEWELS|M2_COLLECT|M2_RIDE,
	M3_INFRAVISIBLE|M3_INFRAVISION, CLR_BLUE),
    MON("Uruk-hai", S_ORC,
	LVL(3, 10, 10, 0, -4), (G_GENO|G_LGROUP|1),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
 ...
 */
	...
	LVL(10, 12, 3, 0, 0), (G_GENO|2),
	A(ATTK(AT_ENGL, AD_DGST, 1, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ2(800, 350, 0, MS_SILENT, MZ_HUGE, 4), 0, 0,
 ...
 */
	...
	LVL(3, 6, 0, 0, 0), (G_GENO|G_NOCORPSE|2),
	A(ATTK(AT_ENGL, AD_PHYS, 1, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ2(0, 0, 0, MS_SILENT, MZ_HUGE, 6), MR_SLEEP|MR_POISON|MR_STONE, 0,
 ...
 */
	...
	CLR_GREEN),
    MON("Aleax", S_ANGEL,
	LVL(10, 12, 0, 30, 7), (G_NOHELL|G_NOCORPSE|1),
	...
	CLR_YELLOW),
    MON("Angel", S_ANGEL,
	LVL(14, 12, -4, 55, 12), (G_NOHELL|G_NOCORPSE|1),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6), 
 ...
 */
	...
	M1_FLY|M1_THICK_HIDE|M1_NOHANDS|M1_CARNIVORE,
	M2_HOSTILE|M2_STRONG|M2_GREEDY|M2_JEWELS, 0, CLR_BLACK),
    MON("baby plain dragon", S_DRAGON,
	LVL(12, 9, 2, 10, 0), G_GENO|G_NOGEN,
	A(ATTK(AT_BITE, AD_PHYS, 2, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(1500, 500, 0, MS_ROAR, MZ_HUGE), 0, 0,
	M1_FLY|M1_THICK_HIDE|M1_NOHANDS|M1_CARNIVORE,
	M2_NOPOLY|M2_HOSTILE|M2_STRONG|M2_GREEDY|M2_JEWELS, 0, CLR_BROWN),
	...
	LVL(15, 12, -1, 20, -4), (G_GENO|1),
	A(ATTK(AT_BREA, AD_FIRE,12,12), ATTK(AT_BITE, AD_PHYS, 3, 8),
	  ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
	  NO_ATTK, NO_ATTK),
	...
	LVL(15, 12, -1, 20, -5), (G_GENO|1),
	A(ATTK(AT_BREA, AD_COLD,12,12), ATTK(AT_BITE, AD_PHYS, 3, 8),
	  ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
	  NO_ATTK, NO_ATTK),
	...
	LVL(15, 12, -1, 20, 5), (G_GENO|1),
	A(ATTK(AT_BREA, AD_PLYS, 4,25), ATTK(AT_BITE, AD_PHYS, 3, 8),
	  ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
	  NO_ATTK, NO_ATTK),
	...
	LVL(15, 12, -1, 20, -7), (G_GENO|1),
	A(ATTK(AT_BREA, AD_ELEC,12,12), ATTK(AT_BITE, AD_PHYS, 3, 8),
	  ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
	  NO_ATTK, NO_ATTK),
	...
	LVL(15, 12, -1, 20, 6), (G_GENO|1),
	A(ATTK(AT_BREA, AD_DRST,12,12), ATTK(AT_BITE, AD_PHYS, 3, 8),
	  ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
	  NO_ATTK, NO_ATTK),
	...
	LVL(15, 12, -1, 20, -8), (G_GENO|1),
	A(ATTK(AT_BITE, AD_DRLI, 2,10), ATTK(AT_CLAW, AD_DRLI, 1, 6),
	  ATTK(AT_CLAW, AD_DRLI, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_DRAGON, 1500, 0, MS_ROAR, MZ_GIGANTIC), 0, 0,
	M1_FLY|M1_THICK_HIDE|M1_NOHANDS|M1_SEE_INVIS|M1_OVIPAROUS|
	  M1_CARNIVORE,
	M2_HOSTILE|M2_STRONG|M2_NASTY|M2_GREEDY|M2_JEWELS|M2_MAGIC, 0, CLR_BLACK),
    MON("plain dragon", S_DRAGON,
	LVL(15, 12, -1, 20, 0), (G_GENO|G_NOGEN),
	...
	M1_FLY|M1_THICK_HIDE|M1_NOHANDS|M1_SEE_INVIS|M1_OVIPAROUS|
	  M1_CARNIVORE,
	M2_NOPOLY|M2_HOSTILE|M2_STRONG|M2_NASTY|M2_GREEDY|M2_JEWELS|M2_MAGIC, 0, CLR_BROWN),
    MON("yellow dragon", S_DRAGON,
	LVL(15, 12, -1, 20, 7), (G_GENO|1),
	A(ATTK(AT_BREA, AD_ACID,12,12), ATTK(AT_BITE, AD_PHYS, 3, 8),
	  ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
	  NO_ATTK, NO_ATTK),
 ...
 */
	...
	LVL(8, 10, 2, 30, 0), (G_NOCORPSE|1),
	A(ATTK(AT_CLAW, AD_RUST, 5, 6), ATTK(AT_ENGL, AD_DRWN, 0, 0),
	  ATTK(AT_NONE, AD_RUST, 0, 0), NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(2500, 0, 0, MS_SILENT, MZ_HUGE), MR_POISON|MR_STONE, 0,
	M1_NOEYES|M1_NOLIMBS|M1_NOHEAD|M1_MINDLESS|
	  M1_AMORPHOUS|M1_AMPHIBIOUS|M1_SWIM,
 ...
 */
	...
	LVL(3, 3, 7, 0, 0), (G_GENO|2),
	A(ATTK(AT_TUCH, AD_PHYS, 1, 4), ATTK(AT_TUCH, AD_STCK, 0, 0),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ2(100, 100, 0, MS_SILENT, MZ_SMALL, 3), MR_POISON, MR_POISON,
	M1_BREATHLESS|M1_NOEYES|M1_NOLIMBS|M1_NOHEAD|M1_MINDLESS|M1_NOTAKE,
	M2_HOSTILE|M2_NEUTER, 0, CLR_MAGENTA),
/*
 * Gnomes
 */
    MON("gnome", S_GNOME,
	LVL(1, 10, 10, 4, 0), (G_GENO|G_SGROUP|1),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
 ...
 */
    ...
    MON("fell beast", S_JABBERWOCK,
	LVL(15, 24, 0, 10, -12), G_GENO|G_NOGEN,
	A(ATTK(AT_BITE, AD_PHYS, 2, 8), ATTK(AT_CLAW, AD_PHYS, 2,10),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(1500, 500, 0, MS_ROAR, MZ_HUGE), 0, 0,
	M1_FLY|M1_THICK_HIDE|M1_NOHANDS|M1_ANIMAL|M1_CARNIVORE|M1_POIS,
	M2_NOPOLY|M2_HOSTILE|M2_STRONG, 0, CLR_BLACK),
#if 0	/* DEFERRED */
 ...
 */
	...
	LVL(1, 10, 10, 10, 9), (G_GENO|G_LGROUP|G_NOGEN),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	LVL(2, 12, 10, 10, 10), (G_GENO|G_SGROUP|G_NOGEN),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 200, 0, MS_ARREST, MZ_HUMAN), 0, 0, M1_HUMANOID,
	...
	LVL(3, 15, 10, 20, 11), (G_GENO|G_NOGEN),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 200, 0, MS_ARREST, MZ_HUMAN), 0, 0, M1_HUMANOID,
	M2_HUMAN|M2_WANDER|M2_HOSTILE|M2_STRONG|M2_MALE|M2_COLLECT,
 ...
 */
	...
	LVL(3, 3, 8, 0, 0), (G_GENO|2),
	A(ATTK(AT_BITE, AD_RUST, 2, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ2(500, 250, 0, MS_SILENT, MZ_MEDIUM, 3),
	...
	A(ATTK(AT_BITE, AD_DCAY, 0, 0),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ2(500, 250, 0, MS_SILENT, MZ_MEDIUM, 2),
 ...
 */
	...
	LVL(0, 7, 10, 0, -2), (G_GENO|G_NOCORPSE|1),
	A(ATTK(AT_CLAW, AD_PHYS, 1, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(400, 50, 0, MS_SILENT, MZ_SMALL), MR_COLD|MR_SLEEP|MR_POISON, 0,
	M1_BREATHLESS|M1_MINDLESS|M1_HUMANOID|M1_POIS,
	...
	LVL(1, 7, 10, 0, -2), (G_GENO|G_NOCORPSE|1),
	...
	LVL(2, 7, 9, 0, -3), (G_GENO|G_SGROUP|G_NOCORPSE|1),
	A(ATTK(AT_CLAW, AD_PHYS, 1, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(850, 75, 0, MS_SILENT, MZ_HUMAN), MR_COLD|MR_SLEEP|MR_POISON, 0,
	M1_BREATHLESS|M1_MINDLESS|M1_HUMANOID|M1_POIS,
	...
	LVL(3, 7, 9, 0, -3), (G_GENO|G_SGROUP|G_NOCORPSE|1),
	...
	LVL(4, 7, 8, 0, -3), (G_GENO|G_SGROUP|G_NOCORPSE|1),
 ...
 */
	...
	SIZ(WT_ELF, 350, 0, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
	M1_HUMANOID|M1_OMNIVORE|M1_SEE_INVIS,
	M2_ELF|M2_COLLECT|M2_RIDE, M3_INFRAVISIBLE|M3_INFRAVISION, CLR_GREEN),
	...
	SIZ(WT_ELF, 350, 0, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
	M1_HUMANOID|M1_OMNIVORE|M1_SEE_INVIS,
	M2_ELF|M2_COLLECT|M2_RIDE, M3_INFRAVISIBLE|M3_INFRAVISION, CLR_BRIGHT_GREEN),
	...
	SIZ(WT_ELF, 350, 0, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
	M1_HUMANOID|M1_OMNIVORE|M1_SEE_INVIS,
	M2_ELF|M2_COLLECT|M2_RIDE, M3_INFRAVISIBLE|M3_INFRAVISION, CLR_GRAY),
	...
	SIZ(WT_ELF, 350, 0, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
	M1_HUMANOID|M1_OMNIVORE|M1_SEE_INVIS,
	M2_ELF|M2_STRONG|M2_LORD|M2_MALE|M2_COLLECT|M2_RIDE,
	...
	SIZ(WT_ELF, 350, 0, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
	M1_HUMANOID|M1_OMNIVORE|M1_SEE_INVIS,
	M2_ELF|M2_STRONG|M2_PRINCE|M2_MALE|M2_COLLECT|M2_RIDE,
	M3_INFRAVISIBLE|M3_INFRAVISION, HI_LORD),
	...
	M1_HUMANOID|M1_OMNIVORE, M2_NOPOLY|M2_HUMAN|M2_HOSTILE|M2_FEMALE,
	M3_INFRAVISIBLE, HI_DOMESTIC),
 ...
 */
	...
	LVL(6, 12, -5, 50, 11), (G_HELL|G_NOCORPSE|2),
...
#undef SEDUCTION_ATTACKS
    ...
    MON("erinys", S_DEMON,
	LVL(7, 18, 2, 30, 10), (G_HELL|G_NOCORPSE|G_SGROUP|2),
	...
	LVL(8, 10, 0, 35, 8), (G_HELL|G_NOCORPSE|G_SGROUP|2),
	A(ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_CLAW, AD_PHYS, 2, 4),
	...
	M3_INFRAVISIBLE|M3_INFRAVISION, CLR_RED),
    MON("hezrou", S_DEMON,
	LVL(9, 12, -2, 55, -10), (G_HELL|G_NOCORPSE|G_SGROUP|2),
	A(ATTK(AT_CLAW, AD_PHYS, 1, 3), ATTK(AT_CLAW, AD_PHYS, 1, 3),
	...
	LVL(11, 12, -4, 55, -12), (G_HELL|G_NOCORPSE|2),
	A(ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
	...
	LVL(13, 12, -3, 65, -13), (G_HELL|G_NOCORPSE|2),
	...
	M3_INFRAVISIBLE|M3_INFRAVISION, CLR_RED),
    MON("balrog", S_DEMON,
	LVL(16, 12, -2, 75, -14), (G_HELL|G_NOCORPSE|1),
	 ...
	 */
    MON("Juiblex", S_DEMON,
	LVL(50, 8, -7, 65, -15), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	A(ATTK(AT_ENGL, AD_DISE, 4,10), ATTK(AT_SPIT, AD_ACID, 3, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ2(1500, 0, 0, MS_GURGLE, MZ_LARGE, 2),
	...
	HI_LORD),
    MON("Geryon", S_DEMON,
	LVL(72, 14, -3, 75, 15), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	A(ATTK(AT_CLAW, AD_PHYS, 3, 6), ATTK(AT_CLAW, AD_PHYS, 3, 6),
	...
	LVL(89, 16, -5, 85, 20), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	...
	A(ATTK(AT_TUCH, AD_DETH, 6, 8), ATTK(AT_TUCH, AD_DETH, 6, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	M2_NOPOLY|M2_STALK|M2_HOSTILE|M2_PNAME|M2_STRONG|M2_NASTY|M2_RIDE,
	M3_INFRAVISIBLE|M3_INFRAVISION, HI_LORD),
    MON("Pestilence", S_DEMON,
	LVL(30, 12, -5, 100, 0), (G_UNIQ|G_NOGEN),
	A(ATTK(AT_TUCH, AD_PEST, 6, 8), ATTK(AT_TUCH, AD_PEST, 6, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 1, 0, MS_RIDER, MZ_HUMAN),
	MR_FIRE|MR_COLD|MR_ELEC|MR_SLEEP|MR_POISON|MR_STONE, 0,
	M1_FLY|M1_HUMANOID|M1_REGEN|M1_SEE_INVIS|M1_TPORT_CNTRL,
    ...
    MON("Famine", S_DEMON,
	LVL(30, 12, -5, 100, 0), (G_UNIQ|G_NOGEN),
	A(ATTK(AT_TUCH, AD_FAMN, 6, 8), ATTK(AT_TUCH, AD_FAMN, 6, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 1, 0, MS_RIDER, MZ_HUMAN),
	MR_FIRE|MR_COLD|MR_ELEC|MR_SLEEP|MR_POISON|MR_STONE, 0,
	M1_FLY|M1_HUMANOID|M1_REGEN|M1_SEE_INVIS|M1_TPORT_CNTRL,
 ...
 */
	...
	M2_HOSTILE, 0, CLR_BLUE),
    MON("piranha", S_EEL,
	LVL(5, 12, 4, 0, 0), (G_GENO|G_NOGEN|G_LGROUP),
    ...
    MON("giant kraken", S_EEL,
	LVL(25, 10, 0, 0, -5), (G_GENO|G_NOGEN),
	A(ATTK(AT_BITE, AD_PHYS, 8, 6), ATTK(AT_SPIT, AD_BLND, 0, 0),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(3000, 2000, 0, MS_SILENT, MZ_GIGANTIC), 0, 0,
	M1_SWIM|M1_AMPHIBIOUS|M1_ANIMAL|M1_NOHANDS|M1_CARNIVORE,
 ...
 */
    ...
    MON("kraken tentacle", S_WORM_TAIL,
	LVL(15, 12, 4, 0, 0), (G_NOGEN|G_NOCORPSE|G_UNIQ),
	A(ATTK(AT_HUGS, AD_WRAP, 2, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(1000, 0, 0, MS_SILENT, MZ_HUGE), 0, 0, 0L, M2_NOPOLY, 0, HI_LORD),
