...
static
const char	* const plusattr[] = {
	"—Í‹­‚­", "’m“I‚É", "‘–¾‚É", "‹@•q‚É", "‹­x‚É", "–£—Í“I‚É",
	"—Í‹­‚³", "’m«",   "‘–¾‚³", "‹@•q‚³", "‹­x‚³", "–£—Í"
},
		* const minusattr[] = {
	"Žã‚­", "“ª‚ªˆ«‚­", "‹ð‚©‚É", "•sŠí—p‚É", "ÆŽã‚É", "X‚­"
};
#endif /*JP*/
...
const struct innate {
	...
	const char *gainstr, *losestr;
		     ...
		     {   1, &(HFast), "", "" },
		     {  10, &(HSearching), E_J("perceptive","ŠÏŽ@—Í‚ð“¾‚½"), E_J("","ŠÏŽ@—Í‚ðŽ¸‚Á‚½") },
		     {	 0, 0, 0, 0 } },

	bar_abil[] = { {	 1, &(HPoison_resistance), "", "" },
		     {   7, &(HFast), E_J("quick","r•q‚É‚È‚Á‚½"), E_J("slow","r•q‚³‚ðŽ¸‚Á‚½") },
		     {  15, &(HStealth), E_J("stealthy","r‰B–§«‚Í‚‚Ü‚Á‚½"), E_J("","r‰B–§«‚Í’á‚­‚È‚Á‚½") },
		     {	 0, 0, 0, 0 } },

	cav_abil[] = { {	 7, &(HFast), E_J("quick","r•q‚É‚È‚Á‚½"), E_J("slow","r•q‚³‚ðŽ¸‚Á‚½") },
		     {	15, &(HWarning), E_J("sensitive","‹C”z‚É•qŠ´‚É‚È‚Á‚½"), E_J("","‹C”z‚É“Ý‚­‚È‚Á‚½") },
		     {	 0, 0, 0, 0 } },
	...
	kni_abil[] = { {	 7, &(HFast), E_J("quick","r•q‚É‚È‚Á‚½"), E_J("slow","r•q‚³‚ðŽ¸‚Á‚½") },
		     {	 0, 0, 0, 0 } },

	mon_abil[] = { {   1, &(HFast), "", "" },
		     {   1, &(HSleep_resistance), "", "" },
		     {   1, &(HSee_invisible), "", "" },
		     {   3, &(HPoison_resistance), E_J("healthy","Œ’N‚É‚È‚Á‚½"), E_J("","–Æ‰u—Í‚Í’á‰º‚µ‚½‚æ‚¤‚¾") },
		     {   5, &(HStealth), E_J("stealthy","r‰B–§«‚Í‚‚Ü‚Á‚½"), E_J("","r‰B–§«‚Í’á‚­‚È‚Á‚½") },
		     {   7, &(HWarning), E_J("sensitive","‹C”z‚É•qŠ´‚É‚È‚Á‚½"), E_J("","‹C”z‚É“Ý‚­‚È‚Á‚½") },
		     {   9, &(HSearching), E_J("perceptive","ŠÏŽ@—Í‚ð“¾‚½"), E_J("unaware","ŠÏŽ@—Í‚ðŽ¸‚Á‚½") },
		     {  11, &(HFire_resistance), E_J("cool","—Á‚µ‚³‚É•ï‚Ü‚ê‚½"), E_J("warmer","‚Ü‚½‹‚­‚È‚Á‚½") },
		     {  13, &(HCold_resistance), E_J("warm","’g‚©‚³‚É•ï‚Ü‚ê‚½"), E_J("cooler","‚Ü‚½Š¦‚­‚È‚Á‚½") },
		     {  15, &(HShock_resistance), E_J("insulated", "â‰‚³‚ê‚½‚æ‚¤‚¾"),
						  E_J("conductive","r“±“d«‚ª–ß‚Á‚½‚æ‚¤‚¾") },
		     {  17, &(HTeleport_control), E_J("controlled","§Œä‚³‚ê‚½"),E_J("uncontrolled","§Œä‚ðŽ¸‚Á‚½") },
		     {   0, 0, 0, 0 } },

	pri_abil[] = { {	15, &(HWarning), E_J("sensitive","‹C”z‚É•qŠ´‚É‚È‚Á‚½"), E_J("","‹C”z‚É“Ý‚­‚È‚Á‚½") },
		     {  20, &(HFire_resistance), E_J("cool","—Á‚µ‚³‚É•ï‚Ü‚ê‚½"), E_J("warmer","‚Ü‚½‹‚­‚È‚Á‚½") },
		     {	 0, 0, 0, 0 } },

	ran_abil[] = { {   1, &(HSearching), "", "" },
		     {	 7, &(HStealth), E_J("stealthy","r‰B–§«‚Í‚‚Ü‚Á‚½"), E_J("","r‰B–§«‚Í’á‚­‚È‚Á‚½") },
		     {	15, &(HSee_invisible), "", "" },
		     {	 0, 0, 0, 0 } },
	...
	tou_abil[] = { {	10, &(HSearching), E_J("perceptive","ŠÏŽ@—Í‚ð“¾‚½"), E_J("","ŠÏŽ@—Í‚ðŽ¸‚Á‚½") },
		     {	20, &(HPoison_resistance), E_J("hardy","‚µ‚Ô‚Æ‚­‚È‚Á‚½"), E_J("","r‚µ‚Ô‚Æ‚³‚ÍŽ¸‚í‚ê‚½") },
		     {	 0, 0, 0, 0 } },
	...
	wiz_abil[] = { {	15, &(HWarning), E_J("sensitive","‹C”z‚É•qŠ´‚É‚È‚Á‚½"), E_J("","‹C”z‚É“Ý‚­‚È‚Á‚½") },
		     {  17, &(HTeleport_control), E_J("controlled","§Œä‚³‚ê‚½"),E_J("uncontrolled","§Œä‚ðŽ¸‚Á‚½") },
		     {	 0, 0, 0, 0 } },

	/* Intrinsics conferred by race */
	elf_abil[] = { {	4, &(HSleep_resistance), E_J("awake","r–°‹C‚Í‹Ž‚Á‚½"), E_J("tired","”æ‚ê‚½") },
		     {	 0, 0, 0, 0 } },
...
{			    /* negative => conditional (msg if change made) */
	...
	if (msgflg <= 0)
	    You_feel(E_J("%s%s!","%s%s‚È‚Á‚½I"),
		  (incr > 1 || incr < -1) ? E_J("very ","‚Æ‚Ä‚à"): "",
...
#else
				    "”½ŽË_Œo‚ð’b‚¦‚Ä‚«‚½‚Éˆá‚¢‚È‚¢B" :
				    "‚±‚Ì‚Æ‚±‚ë”½ŽË_Œo‚ð“Ý‚ç‚¹‚Ä‚¢‚½‚æ‚¤‚¾B");
#endif /*JP*/
				break;
...
#else
				    "Œ’N‚È¶Šˆ‚ðS‚ª‚¯‚Ä‚¢‚½‚Éˆá‚¢‚È‚¢B" :
				    "Ž©•ª‚ÌŒ’N‚É”z—¶‚ª‘«‚è‚È‚©‚Á‚½‚æ‚¤‚¾B");
#endif /*JP*/
				break;
		    }
		}
	...
	while (abil || rabil) {
		...
		if(oldlevel < abil->ulevel && newlevel >= abil->ulevel) {
			...
			if(!(*(abil->ability) & INTRINSIC & ~mask)) {
			    ...
			    {
				if(*(abil->gainstr) == 'r')
				    Your("%sI", &(abil->gainstr[1]));
				else
				    You("%sI", abil->gainstr);
			    }
#endif /*JP*/
			}
			...
			*(abil->ability) &= ~mask;
			if(!(*(abil->ability) & INTRINSIC)) {
			    ...
			    {
				if(*(abil->losestr) == 'r')
				    Your("%sI", &(abil->losestr[1]));
				else
				    You("%sI", abil->losestr);
			    }
#endif /*JP*/
