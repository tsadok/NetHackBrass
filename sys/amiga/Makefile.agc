...
INSTDUNGEONFILES= $(NETHACK)NHBrass.cnf $(INSTDUNGEONFILES1)
...
# Create the directories here because NHBrass.cnf puts them there by default
$(NETHACK)NHBrass.cnf:  $(AMI)NHBrass.cnf
	copy $(AMI)NHBrass.cnf $@
