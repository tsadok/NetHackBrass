...
struct monst {
	...
	uchar permove;		/* actual move per turn */
	xchar mx, my;
...
/*8*/
	Bitfield(mlinktyp, 3);	/* type of mlink */
#define	MLT_NONE	0
#define	MLT_STEED	1	/* mlink is mon's steed */
#define	MLT_RIDER	2	/* mlink is mon's rider */
#define	MLT_SWALLOWING	3	/* mlink is in mon's stomach */
#define	MLT_SWALLOWER	4	/* mlink is swallowing mon */
...
#define STRAT_RIDE	0x00800000L
#define STRAT_XMASK	0x007f0000L
#define STRAT_YMASK	0x00001f00L
...
#define STRAT_GOALY(s)	((xchar)((s & STRAT_YMASK) >> 8))
	...
	long mgold;
#endif
	struct monst *mlink;	/* special mon link */
...
#ifdef JP
#define	JMONNAM(mnum)	(jtrnsmon[mnum] ? jtrnsmon[mnum] : mons[mnum].mname)
#endif
