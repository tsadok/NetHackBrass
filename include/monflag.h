...
#define M2_NEUTER	0x00030000L	/* neither male nor female */
#define M2_SEX		0x00030000L	/* mask bit of male/female/neuter */
#define M2_RIDE		0x00040000L	/* wants to ride on a steed */
...
#define moninstock(x) (!(mvitals[x].mvflags & G_GONE))
