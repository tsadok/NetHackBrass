...
E int FDECL(getobj_filter_repair, (struct obj *));
...
E struct monst* FDECL(findtarget, (int, int));
E boolean NDECL(autotarget);
E int FDECL(getdir_or_pos, (int, int, const char *, const char *));
E int NDECL(getpos2test);
...
E char *FDECL(mon_its, (struct monst *));
E char *FDECL(mon_it, (struct monst *));
...
E void FDECL(refresh_ladies_wear, (struct obj *));
...
E void FDECL(tmiss, (struct obj *, struct monst *));
...
#else
E struct obj *FDECL(floorfood, (const struct getobj_words *,int));
#endif /*JP*/
E void NDECL(vomit);
...
E void FDECL(setup_killername, (struct monst *, char *));
#endif /* !MAKEDEFS_C && !LEV_LEX_C */
...
E boolean FDECL(is_skipreading_engr_at, (XCHAR_P,XCHAR_P));
#ifdef ELBERETH
...
#ifndef JP
E struct obj *FDECL(getobj, (const char *,const char *, int (*)(OBJ_P)));
E int FDECL(ggetobj, (const char *,int (*)(OBJ_P),int,BOOLEAN_P,unsigned *));
#else
E struct obj *FDECL(getobj, (const char *,const struct getobj_words *, int (*)(OBJ_P)));
E int FDECL(ggetobj, (const struct getobj_words *,int (*)(OBJ_P),int,BOOLEAN_P,unsigned *));
#endif /*JP*/
...
#ifdef JP
/* ### japanese.c ### */
E int FDECL(strcmpr, (const char *, const char *));
E char *FDECL(jatoi, (char *, int *));
E void FDECL(ztoh, (char *));
E int FDECL(is_kanji, (unsigned char));
E const char *FDECL(jjosushi, (struct obj *));
E char *FDECL(jget_epitaph, (int));
E void FDECL(jprepare_epitaph, (const char *, int));
...
#endif
E void FDECL(change_light_source_range, (int, genericptr_t, int));
...
E int FDECL(mongets2, (struct monst *,int,int));
...
E struct permonst *NDECL(select_specific_mon);
E int NDECL(wiz_show_rndmonst_prob);
E int FDECL(m_hd,(struct monst *));
...
E int FDECL(mdigest, (struct monst *));
E int FDECL(minstomach, (struct monst *));
E int FDECL(mregurgitate, (struct monst *, BOOLEAN_P, BOOLEAN_P));
...
E void FDECL(init_map,(SCHAR_P));
E void FDECL(join_map,(SCHAR_P,SCHAR_P));
E void FDECL(flood_fill_rm, (int,int,int,BOOLEAN_P,BOOLEAN_P));
E void FDECL(remove_rooms, (int,int,int,int));
E void NDECL(wallify_map);
E void FDECL(mkmap_sub, (SCHAR_P,SCHAR_P,int,int,int));
E void FDECL(mkriver, (SCHAR_P, SCHAR_P));
E void FDECL(mkrndspace, (int,int,int,int,SCHAR_P,SCHAR_P));
E int FDECL(dxdy2dir, (int,int));

/* ### mkmaze.c ### */

E void FDECL(wallification, (int,int,int,int));
E void FDECL(connectwall, (int,int,int,int));
...
E void FDECL(make_rndvault, (const char *));
E void NDECL(init_rndvault);
E void FDECL(save_rndvault, (int, int));
E void FDECL(restore_rndvault, (int));
...
E struct obj *FDECL(mkshopobj_at, (int,int,int));
...
E boolean FDECL(change_material, (struct obj *,int));
E boolean FDECL(rnd_material, (struct obj *));
E struct obj *FDECL(mkicefrozenmon, (int));
...
#endif
E void FDECL(bagotricks, (struct obj *));
E struct obj *FDECL(duplicateobj, (struct obj *));
...
E struct permonst * NDECL(morguemon);
...
E void FDECL(killed_showdmg, (struct monst *, int));
...
E void FDECL(setmpeaceful, (struct monst *,BOOLEAN_P));
...
E boolean FDECL(is_flying, (struct monst *));
E boolean FDECL(is_floating, (struct monst *));
E boolean FDECL(is_swimming, (struct monst *));
E boolean FDECL(is_clinging, (struct monst *));
E int FDECL(pxlth, (int));
#ifdef MONSTEED
E int FDECL(favoritesteed, (int));
E boolean FDECL(isfavoritesteed, (struct permonst *, struct permonst *));
#endif
...
E boolean FDECL(evade_missile, (struct monst *, int, int, int, int));
...
E boolean FDECL(lined_up2, (struct monst *));
...
E int FDECL(missile_hits_shield, (struct monst *, struct obj *));
E int FDECL(elem_hits_shield, (struct monst *, int, const char *));
...
E const char *FDECL(armor_simple_name, (struct obj *));
E const char *FDECL(helm_simple_name, (struct obj *));
E const char *FDECL(Japanese_item_name, (int));
E const char *FDECL(placenam, (uchar));
E const char *FDECL(mimic_obj_name, (struct monst *));
E const char *FDECL(material_word_for_simplename, (struct obj *));
E const char *FDECL(material_prefix, (struct obj *));
E const char *FDECL(armor_colorless_name, (struct obj *));
...
E struct permonst *FDECL(lookat, (int, int, char *, char *));
E void FDECL(doobjdesc, (struct obj *));
...
E void FDECL(freeze_obj, (struct obj *));
E void FDECL(defrost_obj, (struct obj *));
...
E int FDECL(get_wet, (struct obj *));
E int NDECL(dodip);
...
#endif
E struct obj *NDECL(getchargableobj);
...
E boolean FDECL(show_cloud, (int,int,int));
E struct cloud *FDECL(cloud_at, (int,int,int));
E void NDECL(run_cloud);
E void NDECL(test_cloud);
E void FDECL(create_stinking_cloud, (XCHAR_P, XCHAR_P, int, int, BOOLEAN_P));
#ifdef WIZARD
E int NDECL(wiz_cloud_list);
#endif
E void FDECL(save_cloud, (int, struct cloud *, int));
E void FDECL(restore_cloud, (int, long));
...
E void NDECL(fix_stair_rooms);
E boolean FDECL(load_special, (const char *));
E void FDECL(load_preset_vault, (const char *name));
E boolean FDECL(finddpos_special, (coord *,XCHAR_P,XCHAR_P,XCHAR_P,XCHAR_P));
E void NDECL(sort_doors);
...
E void FDECL(know_enchantment, (struct obj *));
E void NDECL(extinguish_torch);
...
#endif
E boolean FDECL(vanish_ether_obj, (struct obj *, struct monst *, const char *));
...
#endif
#ifdef MONSTEED
E boolean FDECL(mcanride, (struct monst *, struct monst *));
E boolean FDECL(mlanding_spot, (struct monst *, coord *cc));
E struct monst *FDECL(mrider_or_msteed, (struct monst *,BOOLEAN_P));
E struct monst *FDECL(target_rider_or_steed, (struct monst *, struct monst *));
E int FDECL(mdismount_steed, (struct monst *));
E struct monst *FDECL(msearchsteed, (struct monst *));
#endif
...
#endif
E boolean NDECL(drownbymon);
E void NDECL(reset_drownbymon);
E void FDECL(start_suffocation, (long));
E void FDECL(end_suffocation, (long));
...
E void FDECL(missum, (struct monst *,struct attack *, int));
E int FDECL(passive, (struct monst *,BOOLEAN_P,int,UCHAR_P, uchar));
E void FDECL(passive_obj, (struct monst *,struct obj *,struct attack *));
E void FDECL(stumble_onto_mimic, (struct monst *));
E int FDECL(flash_hits_mon, (struct monst *,struct obj *));
E int FDECL(reduce_mdmg, (struct monst *, int, int));
...
E int NDECL(abon_luck);
E int NDECL(abon_dex);
E int NDECL(abon);
E int NDECL(dbon);
E int NDECL(doubleattack_roll);
E int NDECL(show_weapon_skills);
E void FDECL(enhance_weapon_skill, (BOOLEAN_P));
E void FDECL(unrestrict_weapon_skill, (int));
E void FDECL(use_skill, (int,int));
E boolean FDECL(skill_gain_check, (int,int));
E int FDECL(calc_skillgain, (int));
E void FDECL(add_weapon_skill, (int, int));
//E void FDECL(lose_weapon_skill, (int));
E int FDECL(weapon_type, (struct obj *));
E int NDECL(uwep_skill_type);
E int FDECL(wepidentify_byhit, (struct obj *));
...
E int NDECL(show_weaponskill);
E int NDECL(show_spell_skill);
E void FDECL(show_available_skills, (const schar *));
E int FDECL(weapon_range, (struct obj *));
...
E struct monst *FDECL(bhitcore, (int,int,int,int,int,int,
				 int (*)(MONST_P,OBJ_P),int (*)(OBJ_P,OBJ_P),
				 struct obj *,BOOLEAN_P));
E struct monst *FDECL(bhitcore2, (int,int,int,int,int,int,
				 int (*)(MONST_P,OBJ_P),int (*)(OBJ_P,OBJ_P),
				 struct obj *,BOOLEAN_P));
