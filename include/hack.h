...
NEARDATA extern struct bresenham bhitpos;	/* place where throw or zap hits or stops */
NEARDATA extern uchar bhitflag;

/* types of calls to bhit() */
#define BHIT_GLYPHMASK		0x000f
#define BHIT_GLYPH_NONE		0
#define BHIT_GLYPH_OBJ		1
#define BHIT_GLYPH_FLASH	2

#define BHIT_ZAPPEDWAND		0x0010	/* zapped wand */
#define BHIT_STOPATSINK		0x0020	/* obj stops if obj passes over a sink */
#define BHIT_FALLTOPOOL		0x0040	/* obj falls into pool/lava */
#define BHIT_OBJTHROWN		0x0080	/* physical obj goes */
#define BHIT_PASSINVIS		0x0100	/* do not hit invisible(transparent) monsters */
#define BHIT_SENSEINVIS		0x0200	/* if obj hits an invisible and unsensed monster, show 'I' */

#define THROWN_WEAPON	(BHIT_GLYPH_OBJ  | BHIT_STOPATSINK | BHIT_OBJTHROWN | BHIT_SENSEINVIS)
#define KICKED_WEAPON	(BHIT_GLYPH_OBJ  | BHIT_STOPATSINK | BHIT_OBJTHROWN | BHIT_SENSEINVIS | BHIT_FALLTOPOOL)
#define GUN_BULLET	(BHIT_GLYPH_NONE | BHIT_STOPATSINK | BHIT_OBJTHROWN | BHIT_SENSEINVIS)
#define ZAPPED_WAND	(BHIT_GLYPH_NONE | BHIT_ZAPPEDWAND)	/* SENSEINVIS is handled in bhitm() */
#define FLASHED_LIGHT	(BHIT_GLYPH_FLASH)
#define INVIS_BEAM	(BHIT_GLYPH_NONE | BHIT_PASSINVIS)	/* mirror */

/* warning specific type of mon */
...
#define MM_MONSTEEDOK	  0x200 /* create monster with his steed */
...
#define ARM_BASE(obj)	(objects[(obj)->otyp].a_ac \
			 - min((int)greatest_erosion(obj),objects[(obj)->otyp].a_ac))
