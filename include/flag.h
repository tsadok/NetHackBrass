...
//#ifdef AUTOTHRUST
//	boolean  autothrust;	/* Automatically target with ranged weapon */
//#endif
	boolean  beginner;
#ifdef MAIL
...
#define discover flags.explore
...
#ifdef PICKUP_THROWN
	boolean	 pickup_thrown;	/* pickup thrown object */
#endif
	...
	boolean  showrexp;	/* show experience points */
#endif
#ifdef SCORE_ON_BOTL
	boolean  showscore;	/* show score */
#endif
        boolean  showweight;    /* show weight */
...
struct instance_flags {
	...
	boolean  IBMrogue;	/* use IBM graphics for rogue-level */
