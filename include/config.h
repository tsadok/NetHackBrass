...
# define HACKDIR "/boot/apps/NetHackBrass"
#endif
#endif
...
# endif
# ifndef DEFAULT_WINDOW_SYS
#  define DEFAULT_WINDOW_SYS "win32y"
# endif
# define HPMON
#endif
 ...
 */
# ifndef HACKDIR
#  define HACKDIR "/usr/games/lib/nhbrassdir"
# endif
...
//#define AUTOTHRUST	/* Automatically target a monster in range with polearms */
#define FIRSTAID	/* scissors/bandage */
#define NOPOLYPILE	/* polymorph affects only one item on the first pile */
#define SHOWDMG		/* show damage value */
#define RAND_MT		/* use mersenne twister for random number */
#define NEWGEHENNOM	/* under construction */
#ifdef STEED
# define MONSTEED	/* monster is riding steeds */
#endif /*STEED*/
/* #define SCORE_ON_BOTL */	/* added by Gary Erickson (erickson@ucivax) */
#define PICKUP_THROWN	/* autopickup thrown object */
#define MAGIC_GLASSES	/* new lenses */
